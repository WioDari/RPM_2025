...
{
    /// <inheritdoc />
    public partial class Satina : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserPlaylistSubscriptions",
                columns: table => new
                {
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    PlaylistId = table.Column<int>(type: "integer", nullable: false),
                    SubscriptionDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("UserPlaylistSubscriptions_pkey", x => new { x.UserId, x.PlaylistId });
                    table.ForeignKey(
                        name: "UserPlaylistSubscriptions_PlaylistId_fkey",
                        column: x => x.PlaylistId,
                        principalTable: "Playlists",
                        principalColumn: "PlaylistId");
                    table.ForeignKey(
                        name: "UserPlaylistSubscriptions_UserId_fkey",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPlaylistSubscriptions_PlaylistId",
                table: "UserPlaylistSubscriptions",
                column: "PlaylistId");
