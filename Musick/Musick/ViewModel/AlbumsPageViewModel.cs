...
namespace Musick.ViewModel
{
     public partial class AlbumsPageViewModel : ObservableObject
    {
        ...
        private AlbumPageViewList _selectedAlbum;

        public AlbumPageViewList SelectedAlbum
        {
            get => _selectedAlbum;
            set
            {
                ...
                WatchAlbumInfo(SelectedAlbum.ID);
                OnPropertyChanged();
        ...
        public void WatchAlbumInfo(int album_id)
        {
            AlbumInfo wr = new AlbumInfo();
            wr.DataContext = new AlbumInfoViewModel(album_id);
            wr.ShowDialog();
        }
